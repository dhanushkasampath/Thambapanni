...
<div align="center">   
  ...
  <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;margin-left:2%;border-radius: 20px;width: 10em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Go to tour" onclick="window.location.href='map.php'" />
    ...
    <div class="row" style="margin-top:3%">
      <div class="col-sm-12 mesh banner-pad">
        <div class="details" id="ss">
          <h2 style="font-family:'Cinzel Decorative', cursive;color: #000;font-size: 38px;">Thuparamaya</h2>
          <br>
          Thuparamaya is a dagoba in Anuradhapura, Sri Lanka. It is a Buddhist sacred place of veneration. <img src="images/4.jpg" alt="thuparamaya" height="200" width="400" align=left>
          ...
          <br>
          <a target="_blank" href="https://lanka.com/about/attractions/thuparamaya/">https://lanka.com/about/attractions/thuparamaya/</a>
   ...
   <!--begining of map-->
    <div id="googleMap" style="width:500px;height:300px; margin-left: 20%;margin-right: 20%;"></div>
